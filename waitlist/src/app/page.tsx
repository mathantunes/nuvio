    ...
    <div style={{ backgroundColor: "var(--color-bg)", color: "var(--color-text)" }}>
      ...
      <div className="sticky top-0 z-40 border-b" style={{ backgroundColor: "var(--color-bg)", borderColor: "var(--color-border)" }}>
        <nav className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          ...
          <img src="/nuvio/logo.png" alt="Nuvio" className="logo" style={{ width: "auto", height: "24px", objectFit: "contain" }} />
          <div className="flex items-center gap-3">
            <a href="https://github.com/mathantunes/nuvio" target="_blank" rel="noopener noreferrer"
              className="hidden text-sm sm:block" style={{ color: "var(--color-text-muted)" }}>
              GitHub
            </a>
            <a href="https://app.nuvio.app/login" className="btn-primary text-sm">Sign in</a>
            <ThemeToggle />
          </div>
        </nav>
      </div>
      ...
      <section className="mx-auto max-w-5xl px-6 py-20 text-center">
        ...
        {/* Waitlist form — replace YOUR_FORMSPREE_ID after signing up at formspree.io */}
        <WaitlistForm />
      ...
      <section className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <p className="mt-4 text-sm" style={{ color: "var(--color-text-muted)" }}>
          Join the waitlist or self-host it yourself. Open source, no lock-in.
        </p>
      ...
      <footer className="border-t py-8" style={{ borderColor: "var(--color-border)" }}>
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-3 px-6 text-xs sm:flex-row sm:justify-between" style={{ color: "var(--color-text-subtle)" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/nuvio/logo.png" alt="Nuvio" className="logo" style={{ width: "auto", height: "18px", objectFit: "contain" }} />
          <p>
            AGPLv3 licensed · Built in the open ·{" "}
            <a href="https://github.com/mathantunes/nuvio" target="_blank" rel="noopener noreferrer" style={{ color: "var(--color-text-muted)" }}>
              GitHub
            </a>
          </p>
        </div>
